...
public class FileUploadControllerTest {
	...
	private static final String API_V1_POSTS_UPLOAD = "/api/v1/posts/upload";
	...
	public <T> ResponseEntity<T> uploadFile(HttpEntity<?> requestEntity, Class<T> responseType) {
		return testRestTemplate.exchange(API_V1_POSTS_UPLOAD, HttpMethod.POST, requestEntity, responseType);
	}
