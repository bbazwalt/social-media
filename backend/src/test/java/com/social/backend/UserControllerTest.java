...
public class UserControllerTest {
	...
	public void postUser_whenUserHasNullUsername_receiveMessageOfNullErrorForUsername() {
		...
		user.setUsername(null);
		ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
		Map<String, String> validationErros = response.getBody().getValidationErrors();
		assertThat(validationErros.get("username")).isEqualTo("Username cannot be null");
	...
	public void postUser_whenUserHasNullPassword_receiveGenericMessageOfNullError() {
		...
		ResponseEntity<ApiError> response = postSignup(user, ApiError.class);
		Map<String, String> validationErros = response.getBody().getValidationErrors();
		assertThat(validationErros.get("password")).isEqualTo("Cannot be null");
	}
	...
	public void getUsers_whenPageIsNegative_receiveFirstPage() {
		String path = API_V1_USERS + "?page=-5";
		ResponseEntity<TestPage<Object>> response = getUsers(path, new ParameterizedTypeReference<TestPage<Object>>() {
		});
